                                ...
                                ?>
                                    ...
                                    switch ($config['type']) {
                                        ...
                                        case "date":
                                                ...
                                                <td><input readonly class="date-picker form-control" value="<?=$record2 -> {$config['field']}?>" name="<?= $config['field'].'[]'?>" placeholder="dd-mm-yyyy" type="text" required="required" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" ></td>
